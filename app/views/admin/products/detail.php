                    ...
                    <div class="row pt-1">
                        <div class="d-flex justify-content-between px-3 mb-4">
                            <a href="danh-sach" class="my-auto text-decoration-none back_home"><i class="bi bi-arrow-left mx-1"></i>Quay
                                lại</a>
                            <div>
                                <a class="btn btn-danger mx-1" data-product-id='<?php echo $id ?>' data-bs-toggle='modal' data-bs-target='#deleteProduct'><i class='mx-1 bi bi-trash'></i>Xóa</a>
                        ...
                        <div class="col-8">
                            <form class="wrap_detail rounded-3 px-3 pt-3 pb-5" id="formSubmit">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $product['link'] ?>" readonly disabled id="link" name="link">
                                </div>
                                <div class="form-group mt-2">
                                    <label class="label_input" for="productName">Tên sản phẩm</label>
                                    <input type="text" class="form-control" value="<?php echo $product['productName'] ?>" readonly disabled id="productName" name="productName">
                                </div>
                                <div class="form-group mt-2">
                                    <label class="label_input" for="productId">ID sản phẩm</label>
                                    <input type="text" class="form-control" value="<?php echo $product['productID'] ?>" readonly disabled id="productId" name="productId">
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="soldCount">Lượt bán</label>
                                        <input type="text" class="form-control" value="<?php echo $product['soldCount'] ?>" readonly disabled id="soldCount" name="soldCount">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="rateCount">Lượt đánh giá</label>
                                        <input type="text" class="form-control" value="<?php echo $product['rateCount'] ?>" readonly disabled id="rateCount" name="rateCount">
                                    </div>
                                </div>
                                <div class="form-group col mt-3">
                                    <label class="label_input" for="status">Trạng thái</label>
                                    <input type="text" class="form-control" value="<?php echo $statusProduct[$product['status']] ?>" readonly disabled id="status" name="status">
                                </div>
                            </form>
                        </div>
                        <div class="col-4">
