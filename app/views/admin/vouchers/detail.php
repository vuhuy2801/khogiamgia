                    ...
                    <div class="row pt-1">
                        <div class="d-flex justify-content-between px-3 mb-4">
                            <a href="danh-sach" class="my-auto text-decoration-none back_home"><i class="bi bi-arrow-left mx-1"></i>Quay
                                lại</a>
                            <div>
                                <a class="btn btn-danger mx-1" data-voucher-id='<?php echo $id ?>' data-bs-toggle='modal' data-bs-target='#deleteVoucher'><i class='mx-1 bi bi-trash'></i>Xóa</a>
                            ...
                            <form class="wrap_detail rounded-3 px-3 pt-3 pb-5" id="formSubmit">
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        ...
                                        <input readonly disabled type="text" class="form-control" id="voucherId" value="<?php echo $voucher['voucherId'] ?>" name="voucherId">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="supplierId">Nhà cung cấp</label>
                                        <input readonly disabled type="text" class="form-control" id="supplierId" value="<?php echo $listSupplier[$voucher['supplierId']] ?>" name="supplierId">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="voucherName">Tên mã giảm giá</label>
                                        <input readonly disabled type="text" class="form-control" value="<?php echo $voucher['voucherName'] ?>" id="voucherName" name="voucherName">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="discountType">Loại mã giảm giá</label>
                                        <input readonly disabled type="text" class="form-control" id="discountType" value="<?php echo $typeDisount[$voucher['discountType']] ?>" name="discountType">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="quantity">Số lượng</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['quantity'] ?>" class="form-control" id="quantity" name="quantity">
                                    </div>

                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="categoryId">Nghành hàng</label>
                                        <input readonly disabled type="text" class="form-control" id="categoryId" value="<?php echo $listCategory[$voucher['categoryId']] ?>" name="categoryId">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="minimumDiscount">Đơn tối thiểu</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['minimumDiscount'] ?>" class="form-control" id="minimumDiscount" name="minimumDiscount">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="maximumDiscount">Giảm tối đa</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['maximumDiscount'] ?>" class="form-control" id="maximumDiscount" name="maximumDiscount">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="conditionsOfUse">Lưu ý</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['conditionsOfUse'] ?>" class="form-control" id="conditionsOfUse" name="conditionsOfUse">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="address_target">Link tiếp thị liên kết</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['address_target'] ?>" class="form-control" id="address_target" name="address_target">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="expressAt">Ngày bắt đầu</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['expressAt'] ?>" class="form-control" id="expressAt" name="expressAt">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="expiresAt">Ngày hết hạn</label>
                                        <input readonly disabled type="text" value="<?php echo $voucher['expiresAt'] ?>" class="form-control" id="expiresAt" name="expiresAt">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        ...
                                        <input readonly disabled type="text" class="form-control" id="is_trend" value="<?php echo $yesOrNo[$voucher['is_trend']] ?>" name="is_trend">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="is_inWallet">Có sẵn trong ví người dùng</label>
                                        <input readonly disabled type="text" class="form-control" id="is_inWallet" value="<?php echo $yesOrNo[$voucher['is_inWallet']] ?>" name="is_inWallet">
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class=''>
                                ...
                                <div class='bg-body py-3 rounded-4 boxInfo'>
                                    ...
                                    <div class="px-3">
                                        ...
                                        <p class="label_input">Thời gian cập nhật: <span class="float-end date_value update_at"><?php echo convertDateFormat($voucher['updatedAt']) ?></span>
                                        </p>
                                    </div>
