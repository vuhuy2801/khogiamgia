                ...
                <div class="toast toast_update align-items-center text-bg-primary border-0 position-absolute start-50 translate-middle"
                    ...
                    <div class="d-flex">
                        <div class="toast-body">
                            Sửa mã giảm giá thành công ! <span></span>
                        </div>
                            ...
                            <form class="wrap_detail rounded-3 px-3 pt-3 pb-5" id="formSubmit" method="POST"
                                ...
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        ...
                                        <input type="text" value="<?php echo $voucher['quantity']?>"
                                            class="form-control" id="quantity" name="quantity">
                                    </div>

                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="categoryId">Nghành hàng</label>
                                        <select class="form-select form-select-sm selectInput" name="categoryId"
                                            id="categoryId">
                                            <?php
                                ...
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="minimunDiscount">Đơn tối thiểu</label>
                                        <input type="text" class="form-control"
                                            value="<?php echo $voucher['minimumDiscount']?>" id="minimunDiscount"
                                            name="minimunDiscount">
                                    </div>
                                    <div class="form-group mt-2 col">
                                        <label class="label_input" for="maximumDiscount">Giảm tối đa</label>
                                        <input type="text" value="<?php echo $voucher['maximumDiscount']?>"
                                ...
                                <div class="row">
                                    <div class="form-group mt-2 col">
                                        ...
                                        <input type="text" value="<?php echo $voucher['conditionsOfUse']?>"
                                    ...
                                    <div class="form-group mt-2 col">
                                        ...
                                        <input type="text" value="<?php echo $voucher['address_target']?>"
