    ...
    <div class="container-fluid">
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col px-3 py-3 wrapContent position-relative">
                ...
                } elseif (isset($_SESSION['addVoucher_success_message'])) {
                    $successMessage = $_SESSION['addVoucher_success_message'];
                    unset($_SESSION['addVoucher_success_message']);
                } elseif (isset($_SESSION['updateVoucher_success_message'])) {
                    $successMessage = $_SESSION['updateVoucher_success_message'];
                    unset($_SESSION['updateVoucher_success_message']);
                }
                if ($successMessage !== '') {
                    echo "<div class=''>
