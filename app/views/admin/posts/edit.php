                        ...
                        <div class="col-8">
                            <form class="wrap_detail rounded-3 px-3 pt-3 pb-5" id="formSubmit" method="POST" action="update">
                                <div class="form-group">
                                    <input type="hidden" value="<?php echo $post['postId'] ?>" class="form-control" id="postId" name="postId">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" value="<?php echo $post['description'] ?>" class="form-control" id="description" name="description">
                                </div>
                                <div class="form-group mt-2">
                                    <label class="label_input" for="slug">Slug</label>
                                    <input type="text" value="<?php echo $post['slug'] ?>" class="form-control" id="slug" name="slug">
                                </div>
                                ...
                                <div class="form-group mt-2">
                                    <input type="hidden" class="form-control" value="<?php echo $post['image'] ?>" id="fakeImage" name="fakeImage">
                                </div>
                                <div class="form-group mt-2">
                                ...
                                <div class="row form-group mt-0 d-flex">
                                    ...
                                    <div class="form-group col mt-0">
                                        ...
                                        <select class="form-select form-select-sm mb-3" name="category_post" id="category_post">
                                            ...
                                            <?php
                                            foreach ($listCategoriesPost as $key => $category) {
